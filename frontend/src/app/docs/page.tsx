...
export const metadata: Metadata = {
  title: "كيف يعمل",
  description:
    "بنية مستشار التمويل: محرك حسابي حتمي يحسب، ونموذج لغوي يشرح — مع حدود العرض التجريبي بصراحة.",
};

export default function DocsPage() {
  return (
    <main className="sitePage docsPage">
      <h1>كيف يعمل مستشار التمويل</h1>
      ...
      <section className="docsSection">
        <h2>الفكرة</h2>
        <p>
          ليست جدول مقارنة آخر. المستشار يقرأ الوضع المالي الفعلي من حركة
